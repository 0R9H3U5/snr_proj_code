    ...
    public partial class UserConfigApp : Form
    {
        ...
        private void AddDataRecv(object item)
        {
            ...
            else
            {
                ...
                this.dataRecvTB.Text = this.dataRecvTB.Text + indata;
                _ReadBuff += indata;
        ...
        private void processReadBuff()
        {
            string[] dataEntries = Regex.Split(_ReadBuff, "Data");
            for (int i = 0; i < dataEntries.Length; i++)
            {
                string[] sensorVal = Regex.Split(dataEntries[i], "\r\n");
                bool sensorValRead = false;
        ...
        private Boolean checkSensorValue( string sensorVal)
        {
            ...
            else if (sensorKeyVal[0] == "VibrationFreq2")
            {
                vib2TB.Text = sensorKeyVal[1];
                return true;
            }
